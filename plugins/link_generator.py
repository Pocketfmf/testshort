...
async def link_generator(client: Client, message: Message):
    ...
    await channel_message.reply_text(f"<strong>Your Batch Files Stored in my Database!</strong>\n\n<strong><i>Modern Link</i></strong> (<i>Recomended Link</i>) :\n\n<code>{url}</code>\n\n<strong><i>Normal Link</i></strong>:\n\n<code>{link}</code>\n\n<strong>LinkShortx:</strong> <code>{share_link}</code>\n\n", quote=True, reply_markup=reply_markup)
